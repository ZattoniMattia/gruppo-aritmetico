...
public class Aritmetrica {
	...
	public String toString(){
            ...
            if(this.dueOpe(this.v_token) && this.parentesi(this.v_token)){
                ...
                if(this.dueOpe(this.v_token)){
                    t+="Operatori multipli ";
                }
                if(this.parentesi(this.v_token)){
	...
	public String inverti(){
        ...
        public int somma(String [] vett){
            ...
            for (int i=0; i<vett.length && vett[i]!=null; i++){
                ris=0;
                switch(v_temp[i]){
        ...
        public String[] remove(String[] v_temp, int ris){
            ...
            for(int j=pos-1; j<vett.length-1 && pos!=0; j++){
                vett[j] = vett[j+1];
            }
            }
        ...
        public static void main(String[]args){
            ...
            Aritmetrica test_3 = new Aritmetrica("(50+50)");
